...
> For International DNSPod, see [DNSPod Global Configuration Guide](dnspod_com.md).
...
For users using Tencent Cloud AccessKey, please refer to [Tencent Cloud DNSPod Configuration Guide](tencentcloud.md).
...
- [Tencent Cloud DNSPod (AccessKey Method)](./tencentcloud.md)
